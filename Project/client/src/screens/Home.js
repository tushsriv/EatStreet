                ...
                <div className="carousel-inner" id="carousel">
                    <div className="carousel-caption" style={{ zIndex: 10 }}>
                        ...
                        <div className="d-flex justify-content-center">
                            <input className="form-control me-2" type="search"
                                placeholder="Search" aria-label="Search" value={search} onChange={(e)=>{setSearch(e.target.value)}}
                            />
                    ...
                    <div className="carousel-item active">
                        <img src="https://source.unsplash.com/random/900×900?burger"
                            className="d-block w-100" alt="..." style={{
                                filter: "brightness(60%)","maxHeight":"450px" 
                            }} />
                    </div>
                    ...
                    <div className="carousel-item">
                        <img src="https://source.unsplash.com/random/900×900?momos"
                            className="d-block w-100" alt="..." style={{
                                filter: "brightness(0%)","maxHeight":"450px" 
                            }} />
                    </div>
                </div>
